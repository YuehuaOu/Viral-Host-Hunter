...
def parse():
    parser = argparse.ArgumentParser(
        description=(
            "Run the Viral-Host-Hunter prediction pipeline for multi-taxonomic-level phage host prediction "
            "using protein and DNA embeddings."
        )
    )
    ...
    parser.add_argument(
        '--model_dir', type=str,
        help="Directory containing trained multi-taxonomic-level models. (default: ./models/multi_taxonomic_levels/{type}/{level})"
    )
    parser.add_argument(
