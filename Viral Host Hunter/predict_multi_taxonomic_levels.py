...
standard_path = f"./model/multi_taxonomic_levels/{type}/{level}/standard_scaler.pkl"
...
# load models
DHH_path = f"./model/multi_taxonomic_levels/{type}/{level}/model.pth"
...
autoencoder_path = f"./model/multi_taxonomic_levels/{type}/{level}/autoencoder.pth"
autoencoder.load_state_dict(torch.load(autoencoder_path))

rf_path = f"./model/multi_taxonomic_levels/{type}/{level}/rf.pth"
